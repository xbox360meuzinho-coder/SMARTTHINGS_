...
// Protegidos por uma chave simples via header, pra evitar uso indevido.
// ---------------------------------------------------------------------------

function checkMcpAuth(req, res, next) {
  // Opcional: se quiser proteger esses endpoints com uma chave própria
  // (diferente do OAuth do SmartThings), defina MCP_API_KEY no .env
  // e descomente a checagem abaixo.
  next();
}

app.get("/mcp/devices", checkMcpAuth, async (req, res) => {
  try {
...
app.get("/mcp/devices/:id/status", checkMcpAuth, async (req, res) => {
  try {
...
app.post("/mcp/devices/:id/on", checkMcpAuth, async (req, res) => {
  try {
...
app.post("/mcp/devices/:id/off", checkMcpAuth, async (req, res) => {
  try {
...
app.post("/mcp/devices/:id/command", checkMcpAuth, async (req, res) => {
  try {
...
app.get("/mcp/rooms", checkMcpAuth, async (req, res) => {
  try {
